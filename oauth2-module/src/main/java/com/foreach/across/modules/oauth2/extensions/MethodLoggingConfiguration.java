 ...
 */
package com.foreach.across.modules.oauth2.extensions;
...
public class MethodLoggingConfiguration
{
	...
	static class MethodExecutionLogger extends MethodLoggerAdapter
	{
		...
		@Pointcut("execution(* com.foreach.across.modules.oauth2.services..*.*(..))")
		public void serviceMethod() {
		}

		@Pointcut("execution(* com.foreach.across.modules.oauth2.repositories..*.*(..))")
