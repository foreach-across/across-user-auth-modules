 ...
 * @since Mar 2016
 */
public class LdapConnectorSettingsRepository extends EntityPropertiesRepository<Long>
{
	public LdapConnectorSettingsRepository( EntityPropertiesDescriptor configuration ) {
		super( configuration );
	}
}
