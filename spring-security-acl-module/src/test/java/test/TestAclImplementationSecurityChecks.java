...
/**
 * Test class orginally copied from the original Spring Security ACL project.
 * Copied and modified for {@link DefaultAclAuthorizationStrategy} custom implementation.
 * <p>
 * See https://github.com/spring-projects/spring-security/issues/4085
 * Once fixed, the custom implementation and this test can be removed.
 *
 * @author Andrei Stefan (original)
 * @author Arne Vandamme
 */
public class TestAclImplementationSecurityChecks
{
	...
	public void testSecurityCheckNoACEs() throws Exception {
		...
		// use a custom granted authority
		SwitchUserGrantedAuthority switchUserGrantedAuthority = new SwitchUserGrantedAuthority( "ROLE_GENERAL", null );

		AclAuthorizationStrategy aclAuthorizationStrategy = new DefaultAclAuthorizationStrategy(
				new SimpleGrantedAuthority( "ROLE_OWNERSHIP" ), new SimpleGrantedAuthority(
				"ROLE_AUDITING" ), switchUserGrantedAuthority );
		...
		AclAuthorizationStrategy aclAuthorizationStrategy2 = new DefaultAclAuthorizationStrategy(
