...
public class MethodLoggingConfiguration
{
	...
	class MethodExecutionLogger extends MethodLoggerAdapter
	{
		...
		@Pointcut("execution(* com.foreach.across.modules.spring.security.acl.services..*.*(..))")
		public void serviceMethod() {
		}

		@Pointcut("execution(* com.foreach.across.modules.spring.security.acl.repositories..*.*(..))")
