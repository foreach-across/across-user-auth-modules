...
/**
 * Copy of {@link org.springframework.security.acls.domain.AclAuthorizationStrategyImpl} that matches
 * {@link org.springframework.security.core.GrantedAuthority} on the value of {@link GrantedAuthority#getAuthority()}
...
public class DefaultAclAuthorizationStrategy implements AclAuthorizationStrategy
{
	 ...
	 */
	public DefaultAclAuthorizationStrategy( GrantedAuthority... auths ) {
	...
	public void securityCheck( Acl acl, int changeType ) {
		...
		if ( AuthenticationUtils.hasAuthority( authentication, requiredAuthority.getAuthority() ) ) {
			return;
		}
