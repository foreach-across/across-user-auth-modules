 ...
 */
public class TestInputGroupFormElementBuilder extends AbstractViewElementBuilderTest<InputGroupFormElementBuilder, InputGroupFormElement>
{
	@Override
	protected InputGroupFormElementBuilder createBuilder( ViewElementBuilderFactory builderFactory ) {
