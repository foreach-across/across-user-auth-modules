 ...
 */
package com.foreach.across.modules.entity.newviews.helpers;
	...
	private ViewElementBuilder getViewElementBuilder( EntityPropertyDescriptor descriptor, Object builderHint ) {
		...
		if ( builderHint instanceof String ) {
			return viewElementBuilderService.createElementBuilder(
					entityConfiguration, descriptor, viewElementMode, (String) builderHint
			);
		}
		...
		return viewElementBuilderService.getElementBuilder( entityConfiguration, descriptor, elementMode );
	}
}
