...
public class ConversionServiceViewElementBuilderFactoryAssembler implements ViewElementBuilderFactoryAssembler
{
	...
	public boolean supports( String viewElementType ) {
		return StringUtils.equalsIgnoreCase( CommonViewElements.TEXT, viewElementType );
	}
	...
	public ViewElementBuilderFactory createBuilderFactory( EntityConfiguration entityConfiguration,
		...
		CloningViewElementBuilderFactory<ConversionServiceViewElementBuilder> builderFactory =
				new CloningViewElementBuilderFactory<>(
						ConversionServiceViewElementBuilder.class );
