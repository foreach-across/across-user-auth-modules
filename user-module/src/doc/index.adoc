...
NOTE: By default the `Permission` entity is `hidden` from the admin UI and can only be managed through code.  If you
want to enable UI management of `Permission` entities, you can modify the `hidden` property using a custom
`EntityConfigurer`.
